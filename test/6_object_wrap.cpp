...
TEST_F(Test, ObjectWrap) {
    ...
    ASSERT_EQ(
            NAPIRunScriptWithSourceUrl(globalEnv,
                                       "(()=>{\"use strict\";var s=Object.getOwnPropertyDescriptor(globalThis.addon.MyObject.prototype,\"value\"),l=Object.getOwnPropertyDescriptor(globalThis.addon.MyObject.prototype,\"valueReadonly\"),t=Object.getOwnPropertyDescriptor(globalThis.addon.MyObject.prototype,\"plusOne\");s?(globalThis.assert.strictEqual(typeof s.get,\"function\"),globalThis.assert.strictEqual(typeof s.set,\"function\"),globalThis.assert.strictEqual(s.value,void 0),globalThis.assert.strictEqual(s.enumerable,!1),globalThis.assert.strictEqual(s.configurable,!1)):globalThis.assert(!1),l?(globalThis.assert.strictEqual(typeof l.get,\"function\"),globalThis.assert.strictEqual(l.set,void 0),globalThis.assert.strictEqual(l.value,void 0),globalThis.assert.strictEqual(l.enumerable,!1),globalThis.assert.strictEqual(l.configurable,!1)):globalThis.assert(!1),t?(globalThis.assert.strictEqual(t.get,void 0),globalThis.assert.strictEqual(t.set,void 0),globalThis.assert.strictEqual(typeof t.value,\"function\"),globalThis.assert.strictEqual(t.enumerable,!1),globalThis.assert.strictEqual(t.configurable,!1)):globalThis.assert(!1);var a=new globalThis.addon.MyObject(9);globalThis.assert.strictEqual(a.value,9),a.value=10,globalThis.assert.strictEqual(a.value,10),globalThis.assert.strictEqual(a.valueReadonly,10),globalThis.assert.strictEqual(a.plusOne(),11),globalThis.assert.strictEqual(a.plusOne(),12),globalThis.assert.strictEqual(a.plusOne(),13),globalThis.assert.strictEqual(a.multiply().value,13),globalThis.assert.strictEqual(a.multiply(10).value,130);var e=a.multiply(-1);globalThis.assert.strictEqual(e.value,-13),globalThis.assert.strictEqual(e.valueReadonly,-13),globalThis.assert.notStrictEqual(a,e)})();",
                                       "https://www.didi.com/6_object_wrap.js",
                                       &result), NAPIOK);
}