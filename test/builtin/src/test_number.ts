...
function testNumber(num: unknown) {
  globalThis.assert.strictEqual(num, globalThis.addon.Test(num));
}
...
function testUint32(input: unknown, expected = input) {
  globalThis.assert.strictEqual(expected, globalThis.addon.TestUint32Truncation(input));
}
...
function testInt32(input: unknown, expected = input) {
  globalThis.assert.strictEqual(expected, globalThis.addon.TestInt32Truncation(input));
}
...
function testInt64(input: unknown, expected = input) {
  globalThis.assert.strictEqual(expected, globalThis.addon.TestInt64Truncation(input));
}
