...
TEST_F(Test, TestArray) {
    ...
    ASSERT_EQ(
            NAPIRunScriptWithSourceUrl(globalEnv,
                                       "(()=>{\"use strict\";var s=[1,9,48,13493,9459324,{name:\"hello\"},[\"world\",\"node\",\"abi\"]];globalThis.assert.throws((function(){globalThis.addon.TestGetElement(s,s.length+1)})),globalThis.assert.throws((function(){globalThis.addon.TestGetElement(s,-2)})),s.forEach((function(a,l){globalThis.assert.strictEqual(globalThis.addon.TestGetElement(s,l),a)})),globalThis.assert(globalThis.addon.TestHasElement(s,0)),globalThis.assert.strictEqual(globalThis.addon.TestHasElement(s,s.length+1),!1),globalThis.assert(globalThis.addon.NewWithLength(0)instanceof Array),globalThis.assert(globalThis.addon.NewWithLength(1)instanceof Array),globalThis.assert(globalThis.addon.NewWithLength(4294967295)instanceof Array);var a=[\"a\",\"b\",\"c\",\"d\"];globalThis.assert.strictEqual(a.length,4),globalThis.assert.strictEqual(2 in a,!0),globalThis.assert.strictEqual(globalThis.addon.TestDeleteElement(a,2),!0),globalThis.assert.strictEqual(a.length,4),globalThis.assert.strictEqual(2 in a,!1)})();",
                                       "https://www.didi.com/test_array.js",
                                       &result), NAPIOK);
}
