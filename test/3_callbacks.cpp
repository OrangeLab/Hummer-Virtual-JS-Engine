...
TEST_F(Test, Callbacks) {
    ...
    ASSERT_EQ(
            NAPIRunScriptWithSourceUrl(globalEnv,
                                       "(()=>{\"use strict\";function l(l){globalThis.addon.RunCallbackWithRecv((function(){globalThis.assert.strictEqual(this,l)}),l)}globalThis.addon.RunCallback((function(l){globalThis.assert.strictEqual(l,\"hello world\")})),l([]),l({})})();",
                                       "https://www.didi.com/3_callbacks.js",
                                       &result), NAPIOK);
}