...
static NAPIValue Get(NAPIEnv env, NAPICallbackInfo info)
{
    ...
    NAPI_ASSERT(env, valuetype0 == NAPIObject, "Wrong type of arguments. Expects an object as first argument.");
...
static NAPIValue GetNamed(NAPIEnv env, NAPICallbackInfo info)
{
    ...
    NAPI_ASSERT(env, value_type0 == NAPIObject, "Wrong type of arguments. Expects an object as first argument.");

    NAPIValueType value_type1;
    NAPI_CALL(env, napi_typeof(env, args[1], &value_type1));

    NAPI_ASSERT(env, value_type1 == NAPIString, "Wrong type of arguments. Expects a string as second.");

    NAPIValue object = args[0];
    NAPI_CALL(env, napi_get_value_string_utf8(env, args[1], key, 255, &key_length));
    key[255] = 0;
    NAPI_ASSERT(env, key_length <= 255, "Cannot accommodate keys longer than 255 bytes");
    NAPIValue output;
...
//     size_t argc = 1;
//     NAPIValue args[1];
//     NAPI_CALL(globalEnv, napi_get_cb_info(globalEnv, info, &argc, args,
//     nullptr, nullptr));
//
...
static NAPIValue HasOwn(NAPIEnv env, NAPICallbackInfo info)
{
    ...
    //
    // NAPI_ASSERT(globalEnv, valuetype1 == NAPIString || valuetype1 ==
    // NAPISymbol,
    //   "Wrong type of arguments. Expects a string or symbol as second.");
...
static NAPIValue TestSetProperty(NAPIEnv env, NAPICallbackInfo /*info*/)
{
    NAPIStatus status;
...
static NAPIValue TestHasProperty(NAPIEnv env, NAPICallbackInfo /*info*/)
{
    NAPIStatus status;
...
static NAPIValue TestGetProperty(NAPIEnv env, NAPICallbackInfo /*info*/)
{
    NAPIStatus status;
...
//
//     NAPI_CALL(globalEnv, napi_get_cb_info(globalEnv, info, &argc,
//     &which_type, nullptr, nullptr)); NAPI_CALL(globalEnv,
//     napi_get_value_uint32(globalEnv, which_type, &type_index));
//     NAPI_CALL(globalEnv, napi_create_object(globalEnv, &instance));
//     NAPI_CALL(globalEnv, napi_type_tag_object(globalEnv, instance,
...
//     uint32_t type_index;
//
//     NAPI_CALL(globalEnv, napi_get_cb_info(globalEnv, info, &argc, argv,
//     nullptr, nullptr)); NAPI_CALL(globalEnv, napi_get_value_uint32(globalEnv,
//     argv[0], &type_index)); NAPI_CALL(globalEnv,
//     napi_check_object_type_tag(globalEnv,
//                                               argv[1],
//                                               &type_tags[type_index],
//                                               &result));
...
TEST_F(Test, TestObject)
{
    NAPIPropertyDescriptor descriptors[] = {
        DECLARE_NAPI_PROPERTY("Get", Get), DECLARE_NAPI_PROPERTY("GetNamed", GetNamed),
        DECLARE_NAPI_PROPERTY("GetPropertyNames", GetPropertyNames),
        //            DECLARE_NAPI_PROPERTY("GetSymbolNames", GetSymbolNames),
        DECLARE_NAPI_PROPERTY("Set", Set), DECLARE_NAPI_PROPERTY("SetNamed", SetNamed),
        DECLARE_NAPI_PROPERTY("Has", Has), DECLARE_NAPI_PROPERTY("HasNamed", HasNamed),
        DECLARE_NAPI_PROPERTY("HasOwn", HasOwn), DECLARE_NAPI_PROPERTY("Delete", Delete),
        DECLARE_NAPI_PROPERTY("New", New), DECLARE_NAPI_PROPERTY("Inflate", Inflate),
        DECLARE_NAPI_PROPERTY("Wrap", Wrap), DECLARE_NAPI_PROPERTY("Unwrap", Unwrap),
        DECLARE_NAPI_PROPERTY("TestSetProperty", TestSetProperty),
        DECLARE_NAPI_PROPERTY("TestHasProperty", TestHasProperty),
        //            DECLARE_NAPI_PROPERTY("TypeTaggedInstance",
        //            TypeTaggedInstance), DECLARE_NAPI_PROPERTY("CheckTypeTag",
        //            CheckTypeTag),
    ...
    ASSERT_EQ(
        NAPIRunScriptWithSourceUrl(
            ...
            "o=e(4058);t.exports=o.Symbol},3916:t=>{t.exports=function(t){if(\"function\"!=typeof t)throw "
            ...
            "t}},1692:(t,r,e)=>{var o=e(4529),n=e(3057),a=e(9413),i=function(t){return function(r,e,i){var "
            "s,l=o(r),u=n(l.length),c=a(i,u);if(t&&e!=e){for(;u>c;)if((s=l[c++])!=s)return!0}else "
            "for(;u>c;c++)if((t||c in l)&&l[c]===e)return "
            "t||c||0;return!t&&-1}};t.exports={includes:i(!0),indexOf:i(!1)}},3610:(t,r,e)=>{var "
            "o=e(6843),n=e(7026),a=e(9678),i=e(3057),s=e(4692),l=[].push,u=function(t){var "
            "r=1==t,e=2==t,u=3==t,c=4==t,f=6==t,p=7==t,b=5==t||f;return function(h,g,d,v){for(var "
            "y,T,m=a(h),w=n(m),x=o(g,d,3),O=i(w.length),S=0,E=v||s,j=r?E(h,O):e||p?E(h,0):void 0;O>S;S++)if((b||S in "
            "w)&&(T=x(y=w[S],S,m),t))if(r)j[S]=T;else if(T)switch(t){case 3:return!0;case 5:return y;case 6:return "
            "S;case 2:l.call(j,y)}else switch(t){case 4:return!1;case 7:l.call(j,y)}return "
            "f?-1:u||c?c:j}};t.exports={forEach:u(0),map:u(1),filter:u(2),some:u(3),every:u(4),find:u(5),findIndex:u(6)"
            ...
            "r.callee?\"Arguments\":o}},2029:(t,r,e)=>{var "
            ...
            "o,n,a=e(1899),i=e(2861),s=a.process,l=s&&s.versions,u=l&&l.v8;u?n=(o=u.split(\".\"))[0]+o[1]:i&&(!(o=i."
            "match(/Edge\\/(\\d+)/))||o[1]>=74)&&(o=i.match(/Chrome\\/(\\d+)/"
            "))&&(n=o[1]),t.exports=n&&+n},6759:t=>{t.exports=[\"constructor\",\"hasOwnProperty\",\"isPrototypeOf\","
            "\"propertyIsEnumerable\",\"toLocaleString\",\"toString\",\"valueOf\"]},6887:(t,r,e)=>{\"use strict\";var "
            "o=e(1899),n=e(9677).f,a=e(7252),i=e(4058),s=e(6843),l=e(2029),u=e(7457),c=function(t){var "
            ...
            "e,f,p,b,h,g,d,v,y=t.target,T=t.global,m=t.stat,w=t.proto,x=T?o:m?o[y]:(o[y]||{}).prototype,O=T?i:i[y]||(i["
            "y]={}),S=O.prototype;for(p in "
            "r)e=!a(T?p:y+(m?\".\":\"#\")+p,t.forced)&&x&&u(x,p),h=O[p],e&&(g=t.noTargetGet?(v=n(x,p))&&v.value:x[p]),"
            "b=e&&g?g:r[p],e&&typeof h==typeof b||(d=t.bind&&e?s(b,o):t.wrap&&e?c(b):w&&\"function\"==typeof "
            "b?s(Function.call,b):b,(t.sham||b&&b.sham||h&&h.sham)&&l(d,\"sham\",!0),O[p]=d,w&&(u(i,f=y+\"Prototype\")|"
            "|l(i,f,{}),i[f][p]=b,t.real&&S&&!S[p]&&l(S,p,b)))}},5981:t=>{t.exports=function(t){try{return!!t()}catch("
            ...
            "o,n,a,i=e(8019),s=e(1899),l=e(941),u=e(2029),c=e(7457),f=e(3030),p=e(4262),b=e(7748),h=\"Object already "
            "initialized\",g=s.WeakMap;if(i){var d=f.state||(f.state=new "
            "g),v=d.get,y=d.has,T=d.set;o=function(t,r){if(y.call(d,t))throw new TypeError(h);return "
            "r.facade=t,T.call(d,t,r),r},n=function(t){return v.call(d,t)||{}},a=function(t){return "
            "y.call(d,t)}}else{var m=p(\"state\");b[m]=!0,o=function(t,r){if(c(t,m))throw new TypeError(h);return "
            "r.facade=t,u(t,m,r),r},n=function(t){return c(t,m)?t[m]:{}},a=function(t){return "
            "c(t,m)}}t.exports={set:o,get:n,has:a,enforce:function(t){return "
            "a(t)?n(t):o(t,{})},getterFor:function(t){return function(r){var e;if(!l(r)||(e=n(r)).type!==t)throw "
            ...
            "o=e(5981),n=/#|\\.prototype\\./,a=function(t,r){var e=s[i(t)];return e==u||e!=l&&(\"function\"==typeof "
            "r?o(r):!!r)},i=a.normalize=function(t){return "
            "String(t).replace(n,\".\").toLowerCase()},s=a.data={},l=a.NATIVE=\"N\",u=a.POLYFILL=\"P\";t.exports=a},"
            ...
            "code/.test(n(a))},9290:(t,r,e)=>{var "
            "o,n=e(6059),a=e(9938),i=e(6759),s=e(7748),l=e(5463),u=e(1333),c=e(4262)(\"IE_PROTO\"),f=function(){},p="
            "function(t){return\"<script>\"+t+\"<\\/script>\"},b=function(){try{o=document.domain&&new "
            "ActiveXObject(\"htmlfile\")}catch(t){}var t,r;b=o?function(t){t.write(p(\"\")),t.close();var "
            "r=t.parentWindow.Object;return "
            "t=null,r}(o):((r=u(\"iframe\")).style.display=\"none\",l.appendChild(r),r.src=String(\"javascript:\"),(t="
            "r.contentWindow.document).open(),t.write(p(\"document.F=Object\")),t.close(),t.F);for(var "
            "e=i.length;e--;)delete b.prototype[i[e]];return b()};s[c]=!0,t.exports=Object.create||function(t,r){var "
            "e;return null!==t?(f.prototype=n(t),e=new f,f.prototype=null,e[c]=t):e=b(),void "
            ...
            "e,o=i(r),s=o.length,l=0;s>l;)n.f(t,e=o[l++],r[e]);return t}},5988:(t,r,e)=>{var "
            ...
            "o=e(5746),n=e(6760),a=e(1887),i=e(4529),s=e(6935),l=e(7457),u=e(2840),c=Object.getOwnPropertyDescriptor;r."
            "f=o?c:function(t,r){if(t=i(t),r=s(r,!0),u)try{return c(t,r)}catch(t){}if(l(t,r))return "
            ...
            "o=e(7457),n=e(4529),a=e(1692).indexOf,i=e(7748);t.exports=function(t,r){var e,s=n(t),l=0,u=[];for(e in "
            "s)!o(i,e)&&o(s,e)&&u.push(e);for(;r.length>l;)o(s,e=r[l++])&&(~a(u,e)||u.push(e));return "
            ...
            "o=e(2885),n=e(5988).f,a=e(2029),i=e(7457),s=e(5623),l=e(9813)(\"toStringTag\");t.exports=function(t,r,e,u)"
            "{if(t){var "
            "c=e?t:t.prototype;i(c,l)||n(c,l,{configurable:!0,value:r}),u&&!o&&a(c,\"toString\",s)}}},4262:(t,r,e)=>{"
            ...
            "o=e(1899),n=e(8726),a=e(7457),i=e(9418),s=e(2497),l=e(2302),u=n(\"wks\"),c=o.Symbol,f=l?c:c&&c."
            "withoutSetter||i;t.exports=function(t){return a(u,t)&&(s||\"string\"==typeof "
            "u[t])||(s&&a(c,t)?u[t]=c[t]:u[t]=f(\"Symbol.\"+t)),u[t]}},8922:(t,r,e)=>{\"use strict\";var "
            "o=e(6887),n=e(5981),a=e(1052),i=e(941),s=e(9678),l=e(3057),u=e(5449),c=e(4692),f=e(568),p=e(9813),b=e("
            "3385),h=p(\"isConcatSpreadable\"),g=9007199254740991,d=\"Maximum allowed index "
            "exceeded\",v=b>=51||!n((function(){var t=[];return "
            "t[h]=!1,t.concat()[0]!==t})),y=f(\"concat\"),T=function(t){if(!i(t))return!1;var r=t[h];return void "
            "0!==r?!!r:a(t)};o({target:\"Array\",proto:!0,forced:!v||!y},{concat:function(t){var "
            "r,e,o,n,a,i=s(this),f=c(i,0),p=0;for(r=-1,o=arguments.length;r<o;r++)if(T(a=-1===r?i:arguments[r])){if(p+("
            "n=l(a.length))>g)throw TypeError(d);for(e=0;e<n;e++,p++)e in a&&u(f,p,a[e])}else{if(p>=g)throw "
            "TypeError(d);u(f,p++,a)}return f.length=p,f}})},9120:(t,r,e)=>{var "
            "o=e(1899);e(904)(o.JSON,\"JSON\",!0)},5327:()=>{},5967:()=>{},1502:()=>{},8555:(t,r,e)=>{e(6349)("
            ...
            "o=e(6887),n=e(1899),a=e(626),i=e(2529),s=e(5746),l=e(2497),u=e(2302),c=e(5981),f=e(7457),p=e(1052),b=e("
            "941),h=e(6059),g=e(9678),d=e(4529),v=e(6935),y=e(1887),T=e(9290),m=e(4771),w=e(946),x=e(684),O=e(7857),S="
            "e(9677),E=e(5988),j=e(6760),q=e(2029),P=e(9754),_=e(8726),N=e(4262),A=e(7748),z=e(9418),H=e(9813),M=e("
            "1477),I=e(6349),F=e(904),k=e(5402),C=e(3610).forEach,D=N(\"hidden\"),G=\"Symbol\",W=H(\"toPrimitive\"),L="
            "k.set,J=k.getterFor(G),U=Object.prototype,B=n.Symbol,Q=a(\"JSON\",\"stringify\"),R=S.f,V=E.f,X=x.f,Y=j.f,"
            "K=_(\"symbols\"),Z=_(\"op-symbols\"),$=_(\"string-to-symbol-registry\"),tt=_(\"symbol-to-string-"
            "registry\"),rt=_(\"wks\"),et=n.QObject,ot=!et||!et.prototype||!et.prototype.findChild,nt=s&&c((function(){"
            "return 7!=T(V({},\"a\",{get:function(){return V(this,\"a\",{value:7}).a}})).a}))?function(t,r,e){var "
            "o=R(U,r);o&&delete U[r],V(t,r,e),o&&t!==U&&V(U,r,o)}:V,at=function(t,r){var e=K[t]=T(B.prototype);return "
            "L(e,{type:G,tag:t,description:r}),s||(e.description=r),e},it=u?function(t){return\"symbol\"==typeof "
            "t}:function(t){return Object(t)instanceof B},st=function(t,r,e){t===U&&st(Z,r,e),h(t);var "
            "o=v(r,!0);return "
            "h(e),f(K,o)?(e.enumerable?(f(t,D)&&t[D][o]&&(t[D][o]=!1),e=T(e,{enumerable:y(0,!1)})):(f(t,D)||V(t,D,y(1,{"
            "})),t[D][o]=!0),nt(t,o,e)):V(t,o,e)},lt=function(t,r){h(t);var e=d(r),o=m(e).concat(pt(e));return "
            "C(o,(function(r){s&&!ut.call(e,r)||st(t,r,e[r])})),t},ut=function(t){var "
            "r=v(t,!0),e=Y.call(this,r);return!(this===U&&f(K,r)&&!f(Z,r))&&(!(e||!f(this,r)||!f(K,r)||f(this,D)&&this["
            "D][r])||e)},ct=function(t,r){var e=d(t),o=v(r,!0);if(e!==U||!f(K,o)||f(Z,o)){var "
            "n=R(e,o);return!n||!f(K,o)||f(e,D)&&e[D][o]||(n.enumerable=!0),n}},ft=function(t){var "
            "r=X(d(t)),e=[];return C(r,(function(t){f(K,t)||f(A,t)||e.push(t)})),e},pt=function(t){var "
            "r=t===U,e=X(r?Z:d(t)),o=[];return "
            "C(e,(function(t){!f(K,t)||r&&!f(U,t)||o.push(K[t])})),o};l||(P((B=function(){if(this instanceof B)throw "
            "TypeError(\"Symbol is not a constructor\");var t=arguments.length&&void "
            "0!==arguments[0]?String(arguments[0]):void "
            "0,r=z(t),e=function(t){this===U&&e.call(Z,t),f(this,D)&&f(this[D],r)&&(this[D][r]=!1),nt(this,r,y(1,t))};"
            "return s&&ot&&nt(U,r,{configurable:!0,set:e}),at(r,t)}).prototype,\"toString\",(function(){return "
            "J(this).tag})),P(B,\"withoutSetter\",(function(t){return "
            "at(z(t),t)})),j.f=ut,E.f=st,S.f=ct,w.f=x.f=ft,O.f=pt,M.f=function(t){return "
            "at(H(t),t)},s&&(V(B.prototype,\"description\",{configurable:!0,get:function(){return "
            "J(this).description}}),i||P(U,\"propertyIsEnumerable\",ut,{unsafe:!0}))),o({global:!0,wrap:!0,forced:!l,"
            "sham:!l},{Symbol:B}),C(m(rt),(function(t){I(t)})),o({target:G,stat:!0,forced:!l},{for:function(t){var "
            ...
            "tt[t]},useSetter:function(){ot=!0},useSimple:function(){ot=!1}}),o({target:\"Object\",stat:!0,forced:!l,"
            "sham:!s},{create:function(t,r){return void "
            "0===r?T(t):lt(T(t),r)},defineProperty:st,defineProperties:lt,getOwnPropertyDescriptor:ct}),o({target:"
            "\"Object\",stat:!0,forced:!l},{getOwnPropertyNames:ft,getOwnPropertySymbols:pt}),o({target:\"Object\","
            "stat:!0,forced:c((function(){O.f(1)}))},{getOwnPropertySymbols:function(t){return "
            "O.f(g(t))}}),Q&&o({target:\"JSON\",stat:!0,forced:!l||c((function(){var "
            "t=B();return\"[null]\"!=Q([t])||\"{}\"!=Q({a:t})||\"{}\"!=Q(Object(t))}))},{stringify:function(t,r,e){for("
            "var o,n=[t],a=1;arguments.length>a;)n.push(arguments[a++]);if(o=r,(b(r)||void 0!==t)&&!it(t))return "
            "p(r)||(r=function(t,r){if(\"function\"==typeof o&&(r=o.call(this,t,r)),!it(r))return "
            "r}),n[1]=r,Q.apply(null,n)}}),B.prototype[W]||q(B.prototype,W,B.prototype.valueOf),F(B,G),A[D]=!0},5915:("
            ...
            "\"unscopables\")},2547:(t,r,e)=>{var o=e(7473);t.exports=o}},r={};function e(o){var n=r[o];if(void "
            "0!==n)return n.exports;var a=r[o]={exports:{}};return t[o](a,a.exports,e),a.exports}e.n=t=>{var "
            ...
            "t=e(2547),r=e.n(t),o={hello:\"world\",array:[1,94,\"str\",12.321,{test:\"obj in "
            "arr\"}],newObject:{test:\"obj in "
            "obj\"}};globalThis.assert.strictEqual(globalThis.addon.Get(o,\"hello\"),\"world\"),globalThis.assert."
            "strictEqual(globalThis.addon.GetNamed(o,\"hello\"),\"world\"),globalThis.assert(globalThis.addon.Has(o,"
            "\"hello\")),globalThis.assert(globalThis.addon.HasNamed(o,\"hello\")),globalThis.assert(globalThis.addon."
            "Has(o,\"array\")),globalThis.assert(globalThis.addon.Has(o,\"newObject\"));var "
            "n=globalThis.addon.New();globalThis.assert(globalThis.addon.Has(n,\"test_number\")),globalThis.assert."
            "strictEqual(n.test_number,987654321),globalThis.assert.strictEqual(n.test_string,\"test string\");var "
            "a=function(){this.foo=42,this.bar=43};a.prototype.bar=44,a.prototype.baz=45;var i=new "
            "a;globalThis.assert.strictEqual(globalThis.addon.Get(i,\"foo\"),42),globalThis.assert.strictEqual("
            "globalThis.addon.Get(i,\"bar\"),43),globalThis.assert.strictEqual(globalThis.addon.Get(i,\"baz\"),45),"
            "globalThis.assert.strictEqual(globalThis.addon.Get(i,\"toString\"),Object.prototype.toString),[!0,!1,null,"
            "void "
            "0,{},[],0,1,function(){}].forEach((function(t){globalThis.assert.throws((function(){globalThis.addon."
            "HasOwn({},t)}))}));var "
            "s=function(){this.foo=42,this.bar=43,this[l]=44},l=r()(),u=r()();s.prototype.bar=45,s.prototype.baz=46,s."
            "prototype[u]=47;var c=new "
            "s;globalThis.assert.strictEqual(globalThis.addon.HasOwn(c,\"foo\"),!0),globalThis.assert.strictEqual("
            "globalThis.addon.HasOwn(c,\"bar\"),!0),globalThis.assert.strictEqual(globalThis.addon.HasOwn(c,l),!0),"
            "globalThis.assert.strictEqual(globalThis.addon.HasOwn(c,\"baz\"),!1),globalThis.assert.strictEqual("
            "globalThis.addon.HasOwn(c,\"toString\"),!1),globalThis.assert.strictEqual(globalThis.addon.HasOwn(c,u),!1)"
            ";var "
            "f={};globalThis.assert(globalThis.addon.Set(f,\"string\",\"value\")),globalThis.assert(globalThis.addon."
            "SetNamed(f,\"named_string\",\"value\")),globalThis.assert(globalThis.addon.Has(f,\"string\")),globalThis."
            "assert(globalThis.addon.HasNamed(f,\"named_string\")),globalThis.assert.strictEqual(globalThis.addon.Get("
            "f,\"string\"),\"value\");var "
            "p={};globalThis.addon.Wrap(p),globalThis.assert(globalThis.addon.Unwrap(p));var "
            "b={};Object.setPrototypeOf(b,{protoA:!0}),globalThis.addon.Wrap(b),globalThis.assert(globalThis.addon."
            "Unwrap(b)),globalThis.assert(b.protoA);var "
            "h=r()(),g={foo:\"bar\",[h]:\"baz\"};globalThis.assert.strictEqual(\"foo\"in "
            "g,!0),globalThis.assert.strictEqual(h in g,!0),globalThis.assert.strictEqual(\"does_not_exist\"in "
            "g,!1),globalThis.assert.strictEqual(globalThis.addon.Delete(g,\"foo\"),!0),globalThis.assert.strictEqual("
            "\"foo\"in g,!1),globalThis.assert.strictEqual(h in "
            "g,!0),globalThis.assert.strictEqual(\"does_not_exist\"in g,!1),globalThis.assert.strictEqual(\"foo\"in "
            "g,!1),globalThis.assert.strictEqual(\"does_not_exist\"in g,!1);var "
            "d={};Object.defineProperty(d,\"foo\",{configurable:!1}),globalThis.assert.strictEqual(globalThis.addon."
            "Delete(d,\"foo\"),!1),globalThis.assert.strictEqual(\"foo\"in d,!0);var "
            "v=function(){this.foo=\"bar\"};v.prototype.foo=\"baz\";var y=new "
