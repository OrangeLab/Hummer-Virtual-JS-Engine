...
static JSValueRef callAsFunction(JSContextRef ctx, JSObjectRef function,
  ...
  JSValueRef valueRef =
      JSObjectGetProperty(ctx, function, keyStringRef, exception);
  ...
  JSValueRef returnValue = (JSValueRef)functionInfo->callback(
      functionInfo->baseInfo.env, &callbackInfo);
...
NAPICommonStatus napi_typeof(NAPIEnv env, NAPIValue value,
  ...
  switch (valueType) {
    ...
    case kJSTypeObject: {
      ...
      JSObjectRef object =
          JSValueToObject(env->context, (JSValueRef)value, &exception);
...
NAPIErrorStatus napi_get_value_double(NAPIEnv env, NAPIValue value,
  ...
  RETURN_STATUS_IF_FALSE(JSValueIsNumber(env->context, (JSValueRef)value),
...
NAPIErrorStatus napi_get_value_bool(NAPIEnv env, NAPIValue value,
  ...
  RETURN_STATUS_IF_FALSE(JSValueIsBoolean(env->context, (JSValueRef)value),
...
NAPIExceptionStatus napi_coerce_to_bool(NAPIEnv env, NAPIValue value,
  ...
  *result = (NAPIValue)JSValueMakeBoolean(
      env->context, JSValueToBoolean(env->context, (JSValueRef)value));
  RETURN_STATUS_IF_FALSE(*result, NAPIExceptionMemoryError)
...
NAPIExceptionStatus napi_coerce_to_number(NAPIEnv env, NAPIValue value,
  ...
  double doubleValue =
      JSValueToNumber(env->context, (JSValueRef)value, &env->lastException);
  CHECK_JSC(env)
...
NAPIExceptionStatus napi_coerce_to_string(NAPIEnv env, NAPIValue value,
  ...
  JSStringRef stringRef =
      JSValueToStringCopy(env->context, (JSValueRef)value, &env->lastException);
  CHECK_JSC(env)
  RETURN_STATUS_IF_FALSE(stringRef, NAPIExceptionMemoryError)
  *result = (NAPIValue)JSValueMakeString(env->context, stringRef);
  JSStringRelease(stringRef);
...
NAPIExceptionStatus napi_set_property(NAPIEnv env, NAPIValue object,
  ...
  RETURN_STATUS_IF_FALSE(JSValueIsObject(env->context, (JSValueRef)object),
                         NAPIExceptionObjectExpected)
  JSObjectRef objectRef =
      JSValueToObject(env->context, (JSValueRef)object, &env->lastException);
  CHECK_JSC(env)
  RETURN_STATUS_IF_FALSE(objectRef, NAPIExceptionMemoryError)

  if (JSValueIsString(env->context, (JSValueRef)key)) {
    JSStringRef stringRef =
        JSValueToStringCopy(env->context, (JSValueRef)key, &env->lastException);
    CHECK_JSC(env)
    RETURN_STATUS_IF_FALSE(stringRef, NAPIExceptionMemoryError)
    JSObjectSetProperty(env->context, objectRef, stringRef, (JSValueRef)value,
    ...
    JSObjectSetPropertyAtIndex(env->context, objectRef,
                               (unsigned int)doubleValue, (JSValueRef)value,
                               &env->lastException);
  } else {
...
NAPIExceptionStatus napi_has_property(NAPIEnv env, NAPIValue object,
  ...
  if (JSValueIsString(env->context, (JSValueRef)key)) {
    ...
    *result = JSObjectHasProperty(env->context, objectRef, stringRef);
    ...
    double doubleValue;
    CHECK_NAPI(napi_get_value_double(env, key, &doubleValue), Error, Exception)
    *result = JSObjectGetPropertyAtIndex(env->context, objectRef,
...
NAPIExceptionStatus napi_get_property(NAPIEnv env, NAPIValue object,
  ...
  if (JSValueIsString(env->context, (JSValueRef)key)) {
    JSStringRef stringRef =
        JSValueToStringCopy(env->context, (JSValueRef)key, &env->lastException);
    RETURN_STATUS_IF_FALSE(stringRef, NAPIExceptionMemoryError)
    *result = (NAPIValue)JSObjectGetProperty(env->context, objectRef, stringRef,
                                             &env->lastException);
    JSStringRelease(stringRef);
  } else if (JSValueIsNumber(env->context, (JSValueRef)key)) {
    double doubleValue;
    CHECK_NAPI(napi_get_value_double(env, key, &doubleValue), Error, Exception)
    *result = (NAPIValue)JSObjectGetPropertyAtIndex(env->context, objectRef,
                                                    (unsigned int)doubleValue,
                                                    &env->lastException);
  } else {
    return NAPIExceptionNameExpected;
...
NAPIExceptionStatus napi_delete_property(NAPIEnv env, NAPIValue object,
  ...
  bool deleteSuccess = JSObjectDeleteProperty(env->context, objectRef,
                                              stringRef, &env->lastException);
  JSStringRelease(stringRef);
  CHECK_JSC(env)
  if (result) {
...
NAPIExceptionStatus napi_call_function(NAPIEnv env, NAPIValue thisValue,
  ...
  RETURN_STATUS_IF_FALSE(JSValueIsObject(env->context, (JSValueRef)func),
                         NAPIExceptionObjectExpected)

  JSObjectRef objectRef =
      JSValueToObject(env->context, (JSValueRef)func, &env->lastException);
  RETURN_STATUS_IF_FALSE(objectRef, NAPIExceptionMemoryError)
  RETURN_STATUS_IF_FALSE(JSObjectIsFunction(env->context, objectRef),
  ...
  if (!thisValue) {
    ...
    RETURN_STATUS_IF_FALSE(JSValueIsObject(env->context, (JSValueRef)thisValue),
                           NAPIExceptionObjectExpected)
    thisObjectRef = JSValueToObject(env->context, (JSValueRef)thisValue,
                                    &env->lastException);
    CHECK_JSC(env)
  }
  JSValueRef returnValue = NULL;
  if (!argc) {
    returnValue = JSObjectCallAsFunction(env->context, objectRef, thisObjectRef,
                                         0, NULL, &env->lastException);
  } else if (argc <= 8) {
    ...
    returnValue =
        JSObjectCallAsFunction(env->context, objectRef, thisObjectRef, argc,
                               argumentArray, &env->lastException);
  } else {
...
NAPIExceptionStatus napi_new_instance(NAPIEnv env, NAPIValue constructor,
  ...
  RETURN_STATUS_IF_FALSE(JSValueIsObject(env->context, (JSValueRef)constructor),
                         NAPIExceptionObjectExpected)
  JSObjectRef objectRef = JSValueToObject(env->context, (JSValueRef)constructor,
                                          &env->lastException);
  CHECK_JSC(env)
  RETURN_STATUS_IF_FALSE(objectRef, NAPIExceptionMemoryError)
  RETURN_STATUS_IF_FALSE(JSObjectIsConstructor(env->context, objectRef),
                         NAPIExceptionFunctionExpected)

  *result = (NAPIValue)JSObjectCallAsConstructor(env->context, objectRef, argc,
...
NAPIExceptionStatus napi_instanceof(NAPIEnv env, NAPIValue object,
  ...
  *result = JSValueIsInstanceOfConstructor(env->context, (JSValueRef)object,
                                           objectRef, &env->lastException);
  CHECK_JSC(env)
...
static JSObjectRef callAsConstructor(JSContextRef ctx, JSObjectRef constructor,
  ...
  JSValueRef prototype =
      JSObjectGetProperty(ctx, constructor, keyStringRef, exception);
  ...
  if (!constructorInfo || !constructorInfo->functionInfo.baseInfo.env ||
...
NAPIExceptionStatus NAPIDefineClass(NAPIEnv env, const char *utf8name,
  ...
  JSObjectRef function = JSObjectMakeConstructor(
      env->context, constructorInfo->classRef, callAsConstructor);
...
NAPIErrorStatus napi_get_value_external(NAPIEnv env, NAPIValue value,
  ...
  RETURN_STATUS_IF_FALSE(JSValueIsObject(env->context, (JSValueRef)value),
...
static NAPIExceptionStatus setWeak(NAPIEnv env, NAPIValue value, NAPIRef ref) {
  ...
  RETURN_STATUS_IF_FALSE(
      valueType == NAPIUndefined || valueType == NAPIExternal,
      NAPIExceptionGenericFailure)
  ...
  if (valueType == NAPIUndefined) {
    ...
    {
      NAPIExceptionStatus status = napi_create_external(
          env, referenceInfo, referenceFinalize, env, &referenceValue);
    ...
    CHECK_NAPI(
        napi_get_value_external(env, referenceValue, (void **)&referenceInfo),
        Error, Exception)
    if (!referenceInfo) {
      assert(false);
...
static NAPIExceptionStatus clearWeak(NAPIEnv env, NAPIRef ref) {
  ...
  CHECK_NAPI(napi_get_property(env, (NAPIValue)ref->value, stringValue,
                               &externalValue),
             Exception, Exception)
  struct ReferenceInfo *referenceInfo;
  CHECK_NAPI(
      napi_get_value_external(env, externalValue, (void **)&referenceInfo),
      Error, Exception)
  if (!referenceInfo) {
    assert(false);
  ...
  if (!LIST_EMPTY(&referenceInfo->referenceList) &&
      LIST_FIRST(&referenceInfo->referenceList) == ref &&
      !LIST_NEXT(ref, node)) {
    bool deleteResult;
    CHECK_NAPI(napi_delete_property(env, (NAPIValue)ref->value, stringValue,
                                    &deleteResult),
               Exception, Exception)
...
NAPIErrorStatus napi_close_escapable_handle_scope(
    __attribute__((unused)) NAPIEnv env, NAPIEscapableHandleScope scope) {
...
NAPIExceptionStatus NAPIRunScript(NAPIEnv env, const char *utf8Script,
                                  const char *utf8SourceUrl,
                                  NAPIValue *result) {
  CHECK_JSC(env)
  ...
  JSValueRef valueRef = JSEvaluateScript(env->context, scriptStringRef, NULL,
                                         sourceUrl, 1, &env->lastException);
...
NAPICommonStatus NAPIEnableDebugger(
    __attribute__((unused)) NAPIEnv env,
...
NAPIErrorStatus NAPICreateEnv(NAPIEnv *env, NAPIRuntime runtime) {
  ...
  *env = malloc(sizeof(struct OpaqueNAPIEnv));
  ...
  (*env)->context =
      JSGlobalContextCreateInGroup((JSContextGroupRef)runtime, NULL);
  if (!(*env)->context) {
    free(*env);
...
NAPICommonStatus NAPIFreeEnv(NAPIEnv env) {
  ...
  LIST_FOREACH_SAFE(referenceInfo, &env->referenceList, node,
                    tempReferenceInfo) {
...
NAPIErrorStatus NAPIGetValueStringUTF8(NAPIEnv env, NAPIValue value,
  ...
  RETURN_STATUS_IF_FALSE(JSValueIsString(env->context, (JSValueRef)value),
                         NAPIErrorStringExpected)
  JSValueRef exception = NULL;
  JSStringRef stringRef =
      JSValueToStringCopy(env->context, (JSValueRef)value, &exception);
...
NAPI_EXPORT NAPIExceptionStatus
NAPICompileToByteBuffer(__attribute__((unused)) NAPIEnv env,
...
NAPI_EXPORT NAPICommonStatus NAPIFreeByteBuffer(__attribute__((unused))
                                                NAPIEnv env,
                                                __attribute__((unused))
...
NAPI_EXPORT NAPIExceptionStatus
NAPIRunByteBuffer(__attribute__((unused)) NAPIEnv env,
                  __attribute__((unused)) const uint8_t *byteBuffer,
                  __attribute__((unused)) size_t bufferSize,
