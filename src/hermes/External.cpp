...
orangelabs::External::External(::hermes::vm::Runtime &runtime, void *data,
                               ...
                               void *finalizeHint)
    : runtime(runtime), data(data), finalizeCallback(finalizeCallback),
...
orangelabs::External::get(::hermes::vm::SymbolID symbolId) {
  return ::hermes::vm::Runtime::getUndefinedValue().get();
}

::hermes::vm::CallResult<bool>
orangelabs::External::set(::hermes::vm::SymbolID symbolId,
